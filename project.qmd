...
fed_funds <- fed_funds |> 
  ...
  summarise(fed_funds_rate = sum(FEDFUNDS)) |> 
  ungroup() |> 
  mutate(fed_funds_lag1 = lag(fed_funds_rate, 1),
         fed_funds_lag2 = lag(fed_funds_rate, 2),
         fed_funds_lag3 = lag(fed_funds_rate, 3),
         fed_funds_lag4 = lag(fed_funds_rate, 4),
         fed_funds_chg_qtr1 = fed_funds_rate - lag(fed_funds_rate, 1),
         fed_funds_chg_qtr2 = fed_funds_rate - lag(fed_funds_rate, 2),
         fed_funds_chg_qtr3 = fed_funds_rate - lag(fed_funds_rate, 3),
