...
emplvl_lm <- plm(data = data, emplvl_growth_yr ~ fed_district:fed_funds_chg_qtr + 
                   fed_district:fed_funds_chg_lag1 + 
                   fed_district:fed_funds_chg_lag2 +
                   fed_district:fed_funds_chg_lag3 +
                   fed_district:fed_funds_chg_lag4,
                 index = c("area_fips", "date"), model  ="within", effect = "twoways")

summary(emplvl_lm)

emplvl_lm_simple <- plm(
  emplvl_growth_yr ~
    fed_district:fed_funds_chg_qtr,
  data = data,
  index = c("area_fips", "date"),
  model = "within",
  effect = "twoways"
)

summary(emplvl_lm_simple)
```
